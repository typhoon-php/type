...
return [
    ...
    constr('floatValue', 'T', [tpl('T', 'float')], [prop('value', $bigNumberClass)], 'floatRange($value, $value)'),
    constr('floatRange', 'T', [tpl('T', 'float')], [prop('min', '?' . $bigNumberClass), prop('max', '?' . $bigNumberClass)]),
    // string
