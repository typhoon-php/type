...
final class StringifyTest extends TestCase
{
    ...
    public static function provideCases(): iterable
    {
        ...
        yield [arrayShapeT([intT]), 'array{int}'];
        ...
        // todo yield [classStringT, 'class-string'];
        // todo yield [objectShapeT(), 'object'];
        // todo yield [objectShapeT(['name' => stringT, 'obj' => objectT(\stdClass::class)]), 'object{name: string, obj: stdClass}'];
        // todo yield [objectShapeT(['name' => optional(stringT)]), 'object{name?: string}'];
        // todo yield [objectShapeT(['n\'ame' => stringT]), "object{'n\\'ame': string}"];
        // todo yield [objectShapeT(["\n" => stringT]), "object{'\\n': string}"];
